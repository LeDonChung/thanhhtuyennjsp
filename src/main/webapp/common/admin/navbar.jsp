<!-- partial:partials/_navbar.html -->
		<nav
			...
			<div
				...
				<a class="navbar-brand brand-logo" href="<c:url value="/admin/home"></c:url>"><img
					src="<c:url value="/template/admin/images/logo.svg"></c:url>"
					alt="logo" /></a> <a class="navbar-brand brand-logo-mini"
					href="index.html"><img
					src="<c:url value="/template/admin/images/logo-mini.svg"></c:url>"
					alt="logo" /></a>
			</div>
					...
					<li class="nav-item nav-profile dropdown"><a
						...
						data-bs-toggle="dropdown" aria-expanded="false">
							<div class="nav-profile-img">
								<img
									src="<c:url value="/template/admin/images/faces/face1.jpg"></c:url>"
						...
						<div
							...
							<a class="dropdown-item preview-item">
								<div class="preview-thumbnail">
									<img
										src="<c:url value="/template/admin/images/faces/face4.jpg"></c:url>"
							...
							<a class="dropdown-item preview-item">
								<div class="preview-thumbnail">
									<img
										src="<c:url value="/template/admin/images/faces/face2.jpg"></c:url>"
										alt="image" class="profile-pic">
								</div>
								<div
									class="preview-item-content d-flex align-items-start flex-column justify-content-center">
							...
							<a class="dropdown-item preview-item">
								<div class="preview-thumbnail">
									<img
										src="<c:url value="/template/admin/images/faces/face3.jpg"></c:url>"
										alt="image" class="profile-pic">
								</div>
								<div
									class="preview-item-content d-flex align-items-start flex-column justify-content-center">
